#!/usr/bin/env node
/**
 * Envia briefing diario de posts para o designer via Resend API.
 * Uso: node tools/send_dzn_brief.js <subject_file> <body_html_file>
 */
...
const TO = ["lezesdzn@gmail.com", "digui.slater@gmail.com", "contato@localriseadvisory.com"];

if (process.argv.length !== 4) {
  console.error("Uso: node send_dzn_brief.js <subject_file> <body_html_file>");
  process.exit(1);
}
